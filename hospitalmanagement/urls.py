...
urlpatterns = [
    ...
    path('doctor-approve-appointment-action/<int:pk>', views.doctor_approve_appointment_action_view, name='doctor-approve-appointment-action'),
    path('doctor-reject-appointment/<int:pk>', views.doctor_reject_appointment_view, name='doctor-reject-appointment'),
    ...
    path('patient-medical-records', views.patient_medical_records_view, name='patient-medical-records'),
    path('patient-reapply', views.patient_reapply_view, name='patient-reapply'),
]
